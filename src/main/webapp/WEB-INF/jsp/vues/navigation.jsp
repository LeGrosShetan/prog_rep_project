        ...
        <ul class="nav navbar-nav">
            ...
            <c:if test="${sessionScope.id > 0  }">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/emprunt/listerEmprunts">
                            <span class="glyphicon glyphicon-th-list"></span> Lister les emprunts</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/reservation/listerReservations.htm"> <span class="glyphicon glyphicon-plus"></span> Lister Reservation</a></li>
                    </ul>
                </li>
